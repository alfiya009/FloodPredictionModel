...
print("🚀 Final Robust Training with Clean Real Data...")
print("=" * 60)
...
# Data preprocessing
print("\n🔧 Final Robust Data Preprocessing...")

# Drop problematic columns
columns_to_drop = ['DATE', 'Drainage_properties', 'Drainage_line_id', 'Ward Code', 'Areas', 'Nearest Station', 'Land Use Classes', 'Soil Type']
...
# Save all models
print("\n💾 Saving Models...")
joblib.dump(ensemble, 'final_robust_ensemble.joblib')
joblib.dump(rf, 'final_robust_rf.joblib')
joblib.dump(svm, 'final_robust_svm.joblib')
joblib.dump(scaler, 'final_robust_scaler.joblib')
joblib.dump(le, 'final_robust_label_encoder.joblib')

print("✅ All final robust models saved successfully!")
print(f"\n📊 Final Results:")
...
print("\n🎉 Final robust training completed successfully!")
print("📁 Files created:")
print("   - final_robust_ensemble.joblib")
print("   - final_robust_rf.joblib")
print("   - final_robust_svm.joblib")
print("   - final_robust_scaler.joblib")
print("   - final_robust_label_encoder.joblib")
